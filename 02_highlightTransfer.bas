...
Private Sub BNZHighlightMatchingRows(sheetName1 As String, sheetName2 As String, highlightColor As Long)
    Dim sheet1 As Worksheet
    Dim sheet2 As Worksheet
    Dim lastRow1 As Long
    Dim lastRow2 As Long
...
Private Sub BNZToWestpacHighlightMatchingRows(sheetName1 As String, sheetName2 As String, highlightColor As Long)
...
Sub HightlightTransfer()    
    ...
    BNZHighlightMatchingRows "C-BNZ-go", "S-BNZ-loan", LightBlue 'darkBlue
    ...
    ASBLoanHighlightMatchingRows "Y-ASB", "S-BNZ-loan", LightYellow 'lightBlue
End Sub
